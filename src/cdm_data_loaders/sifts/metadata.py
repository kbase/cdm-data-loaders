...
The descriptor is stored at::
    ...
    {key_prefix}/derived_data/sifts/metadata/sifts_datapackage.json

and archived at::

    {key_prefix}/derived_data/archive/{date_tag}/sifts/metadata/sifts_datapackage.json
...
_DESCRIPTOR_SUBPATH = "derived_data/sifts/metadata/sifts_datapackage.json"
...
def build_descriptor_key(key_prefix: str) -> str:
    ...
    :return: S3 key ending with ``derived_data/sifts/metadata/sifts_datapackage.json``
    """
...
def build_archive_descriptor_key(key_prefix: str, date_tag: str) -> str:
    ...
    :return: S3 key under ``derived_data/archive/{date_tag}/sifts/metadata/``
    """
    prefix = key_prefix.rstrip("/") + "/"
    return f"{prefix}derived_data/archive/{date_tag}/sifts/metadata/sifts_datapackage.json"
